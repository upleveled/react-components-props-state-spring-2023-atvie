...
export default function ExampleChildrenProps() {
  return (
    <>
      <BlogPost title="This Is A Post About Animals" number={1}>
        <img
      ...
      <BlogPost title="This Is A Post About Fruits" number={2}>
        <p>
      ...
      <BlogPost title="This Is A Post About Pokemons" number={3}>
        <img
          src="https://images.pexels.com/photos/17811/pexels-photo.jpg?cs=srgb&dl=pexels-carlos-spitzer-17811.jpg&fm=jpg"
          alt="tucan"
          width="100"
      ...
      <BlogPost title="This Is A Post About Flex Box" number={4}>
        <p>
